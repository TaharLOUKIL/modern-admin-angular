...
exports.isStandaloneProject = exports.readNxJson = exports.readProjectConfiguration = exports.updateWorkspaceConfiguration = exports.readWorkspaceConfiguration = exports.getProjects = exports.removeProjectConfiguration = exports.updateProjectConfiguration = exports.addProjectConfiguration = void 0;
 ...
 */
function addProjectConfiguration(tree, projectName, projectConfiguration, standalone = false) {
    standalone = standalone || get_workspace_layout_1.getWorkspaceLayout(tree).standaloneAsDefault;
...
function readWorkspaceConfiguration(tree) {
    ...
    return Object.assign(Object.assign({}, workspace), (nxJson === null ? {} : nxJson));
}
...
function updateWorkspaceConfiguration(tree, workspaceConfig) {
    ...
    version, cli, defaultProject, generators, 
    // Nx Json Properties
    implicitDependencies, plugins, npmScope, targetDependencies, workspaceLayout, tasksRunnerOptions, affected, } = workspaceConfig;
    const workspace = {
        version,
        cli,
        defaultProject,
...
function readNxJson(tree) {
    ...
    return json_1.readJson(tree, 'nx.json');
}
...
function getProjectConfiguration(projectName, workspace, nxJson) {
    return Object.assign(Object.assign({}, readWorkspaceSection(workspace, projectName)), (nxJson === null ? {} : readNxJsonSection(nxJson, projectName)));
}
...
function setProjectConfiguration(tree, projectName, projectConfiguration, mode, standalone = false) {
    ...
    if (hasNxJson) {
        ...
        addProjectToNxJson(tree, projectName, {
            tags,
            implicitDependencies,
        }, mode);
    }
...
function addProjectToWorkspaceJson(tree, projectName, project, mode, standalone = false) {
    ...
    json_1.writeJson(tree, path, workspaceJson);
}
function addProjectToNxJson(tree, projectName, config, mode) {
    ...
    if (!getProjectFileLocation(tree, projectName)) {
        const nxJson = json_1.readJson(tree, 'nx.json');
        if (mode === 'delete') {
        ...
        json_1.writeJson(tree, 'nx.json', nxJson);
    }
}
