(function (global, factory) {
    ...
    var DEVICES_RE = Object.assign(Object.assign(Object.assign({}, MOBILES_RE), TABLETS_RE), { FIREFOX_OS: { and: [/\bFirefox\b/, /\bMobile\b/] }, CHROME_BOOK: /\bCrOS\b/, PS4: /\bMozilla\/5.0 \(PlayStation 4\b/, CHROMECAST: /\bCrKey\b/, APPLE_TV: /^iTunes-AppleTV\/4.1$/, GOOGLE_TV: /\bGoogleTV\b/, Tesla: /Tesla\/([0-9]{4}.[0-9]{1,2}.?[0-9]{0,2}.?[0-9]{0,2})-(.{7})/ });
    ...
    var ReTree = /** @class */ (function () {
        ...
        ReTree.prototype.test = function (str, regex) {
            var _this = this;
        ...
        ReTree.prototype.exec = function (str, regex) {
            var _this = this;
            if (typeof regex === 'string') {
                regex = new RegExp(regex);
            }
            if (regex instanceof RegExp) {
                ...
                return regex.reduce(function (res, item) {
                    return !!res ? res : _this.exec(str, item);
                }, null);
            }
            else {
                return null;
    ...
    var DeviceDetectorService = /** @class */ (function () {
        ...
        DeviceDetectorService.prototype.isDesktop = function (userAgent) {
            if (userAgent === void 0) { userAgent = this.userAgent; }
            var desktopDevices = [DEVICES.PS4, DEVICES.CHROME_BOOK, DEVICES.UNKNOWN];
