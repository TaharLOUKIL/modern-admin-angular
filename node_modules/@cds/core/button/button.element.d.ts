...
export declare const iconSpinner: (size: string) => import("lit-html").TemplateResult<1>;
export declare const iconCheck: import("lit-html").TemplateResult<1>;
export declare const iconError: import("lit-html").TemplateResult<1>;
