...
var DndList = (function () {
    ...
    DndList = __decorate([ __metadata("design:paramtypes", [ElementRef,
            DndState])
    ], DndList);
DndList.ɵfac = function DndList_Factory(t) { return new (t || DndList)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DndState)); };
DndList.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: DndList, selectors: [["", "dndList", ""]], hostBindings: function DndList_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("dragenter", function DndList_dragenter_HostBindingHandler($event) { return ctx.handleDragEnter($event); })("dragover", function DndList_dragover_HostBindingHandler($event) { return ctx.handleDragOver($event); })("drop", function DndList_drop_HostBindingHandler($event) { return ctx.handleDrop($event); })("dragleave", function DndList_dragleave_HostBindingHandler($event) { return ctx.handleDragLeave($event); });
    } }, inputs: { option: ["dndList", "option"], dndPlaceholder: "dndPlaceholder", dndModel: "dndModel" }, outputs: { dndDragOver: "dndDragOver", dndDrop: "dndDrop", dndInserted: "dndInserted" } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DndList, [{
        type: Directive,
        args: [{
                selector: '[dndList]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc1.DndState }]; }, { option: [{
            type: Input,
            args: ['dndList']
        }], dndDragOver: [{
            type: Output,
