(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('rxjs'), require('@ngx-translate/core'), require('@angular/core'), require('@angular/forms'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-datatable-footer', ['exports', 'rxjs/operators', 'rxjs', '@ngx-translate/core', '@angular/core', '@angular/forms', '@angular/common'], factory) :
    (factory((global['ngx-datatable-footer'] = {}),global.rxjs.operators,global.rxjs,global.core,global.ng.core,global.ng.forms,global.ng.common));
}(this, (function (exports,operators,rxjs,core,core$1,forms,common) { 'use strict';
    ...
    var DatatablePagerComponent = /** @class */ (function () {
        function DatatablePagerComponent() {
            ...
            this.change = new core$1.EventEmitter();
            this.pageChange = new core$1.EventEmitter();
            this.maxPage = new core$1.EventEmitter();
         ...
         */
            function () {
                ...
                this.inputEvent = rxjs.fromEvent(this.customerInput.nativeElement, "input")
                    .pipe(operators.debounceTime(this.pageJumpTime))
        ...
        DatatablePagerComponent.propDecorators = {
            pagerLeftArrowIcon: [{ type: core$1.Input }],
            pagerRightArrowIcon: [{ type: core$1.Input }],
            pagerPreviousIcon: [{ type: core$1.Input }],
            pagerNextIcon: [{ type: core$1.Input }],
            pageSizes: [{ type: core$1.Input }],
            datatable: [{ type: core$1.Input }],
            linage: [{ type: core$1.Input }],
            displayBothEnds: [{ type: core$1.Input }],
            pageNumber: [{ type: core$1.Input }],
            pageJumpTime: [{ type: core$1.Input }],
            labels: [{ type: core$1.Input }],
            size: [{ type: core$1.Input }],
            count: [{ type: core$1.Input }],
            page: [{ type: core$1.Input }],
            change: [{ type: core$1.Output }],
            pageChange: [{ type: core$1.Output }],
            maxPage: [{ type: core$1.Output }],
            customerInput: [{ type: core$1.ViewChild, args: ["customerInput",] }]
        };
    ...
    var FooterConfigurationService = /** @class */ (function () {
        ...
        /** @nocollapse */
        FooterConfigurationService.ctorParameters = function () {
            return [
    ...
    exports.ɵa = FooterConfigurationService;
