...
export declare abstract class NgbDateParserFormatter {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgbDateParserFormatter, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<NgbDateParserFormatter>;
}
export declare class NgbDateISOParserFormatter extends NgbDateParserFormatter {
    parse(value: string): NgbDateStruct;
    format(date: NgbDateStruct): string;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgbDateISOParserFormatter, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<NgbDateISOParserFormatter>;
}
